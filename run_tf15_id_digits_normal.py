"""
Runs the Moving MNIST trained model on ID_NORMAL.npz with 15 ground-truth
...
NPZ_FILE      = "data/custom/ID_NORMAL.npz"
RESULTS_DIR   = "results/id_digits/id_digits_normal/tf15_prediction_plots"
NT            = 20
CONTEXT_K     = 15
BATCH_SIZE    = 8
N_PLOT        = 5
...
for i in range(min(N_PLOT, X.shape[0])):
    ...
    fig.suptitle(
        f"ID Digits Normal — Seq {i} — k={CONTEXT_K} context frames "
